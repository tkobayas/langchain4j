...
public record MethodAgentSpecification(Method method, String name, String description, String outputName, List<String> arguments) implements AgentSpecification {
