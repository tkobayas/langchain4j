...
public class HoroscopeMain {
    ...
    public static void main(String[] args) {
        UserAskerAgent askerAgent = AgentServices.agentBuilder(UserAskerAgent.class)
        ...
        System.out.println(horoscopeAgent.invoke("My name is Mario. What is my horoscope?"));
    }
}
